"Desafio! Vocês foram contratados para Desenvolver um sistema para registrar vendas de uma loja de doce"
...
"o encerrar o programa, o sistema sorteia uma das vendas do dia para enviar um brinde para o cliente sorteado (fica ao seu criterio entender como fazer o sorteio)"
